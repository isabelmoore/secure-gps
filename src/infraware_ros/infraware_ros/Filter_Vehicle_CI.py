...
track1=[[],[],[],[],[],[],[],[]]
Health=[[],[]]
class GNN_Filter_CI(Node):
    def __init__(self):
        super().__init__('FilterInfraCI')
        ...
        self.gps_x =[0.]
        self.gps_y =[0.]
        # self.file1 = open("Track_straight_spoof_CI.txt","w")
        # self.file2 = open("Health_straight_spoof_CI.txt","w")

        # self.file1 = open("Track_circle_spoof_CI.txt","w")
        # self.file2 = open("Health_circle_spoof_CI.txt","w")

        # self.file1 = open("Track_lanechange_spoof_CI.txt","w")
        # self.file2 = open("Health_lanechange_spoof_CI.txt","w")
    ...
    def export_pos(self):
        ...
        # df.to_csv('Track_Sensor_CI_Straight.txt', index=False)
        # df.to_csv('Track_Sensor_CI_LaneChange.txt', index=False)
        df.to_csv('Track_Sensor_CI_Circle.txt', index=False)
