...
##### OPENING SHARF DATA ####
path = "/home/iea/IEA_Demo/MKZ_SIMULATOR_PROTYPE1/Data/Ramp 0.01/SHARF"
os.chdir(path)
print(os.getcwd())
...
path = "/home/iea/IEA_Demo/MKZ_SIMULATOR_PROTYPE1/Data/Ramp 0.01/KF"
os.chdir(path)
print(os.getcwd())
with open('Track_circle_spoof.txt','r') as csvfile:
    plots = csv.reader(csvfile, delimiter=',')
...
path = "/home/iea/IEA_Demo/MKZ_SIMULATOR_PROTYPE1/Data/Ramp 0.01/KF_no_detector"
os.chdir(path)
print(os.getcwd())
with open('Track_circle_spoof.txt','r') as csvfile:
    plots = csv.reader(csvfile, delimiter=',')
...
path = "/home/iea/IEA_Demo/MKZ_SIMULATOR_PROTYPE1/Data/Ramp 0.01/CI"
os.chdir(path)
print(os.getcwd())
with open('Track_circle_spoof.txt','r') as csvfile:
    plots = csv.reader(csvfile, delimiter=',')
...
sns.boxplot(y = "TotalError",
            x = "Scenario",
            hue = "Algorithm",data =df, palette="tab10",showfliers=False,showmeans=True)
